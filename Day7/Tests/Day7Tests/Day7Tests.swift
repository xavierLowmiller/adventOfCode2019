...
final class Day7Tests: XCTestCase {
	...
	func testExamplesDay7Part2() {
		// Given
		let examples: [(config: [Int], input: [Int], maxValue: Int)] = [
			([9, 8, 7, 6, 5], [3,26,1001,26,-4,26,3,27,1002,27,2,27,1,27,26,
		...
		for example in examples {
			// When
			let assembly = FeedbackLoopAssembly(
				memory: example.input,
				phaseSettings: example.config
			)
	...
	func testDay7Part1() {
		print("Solution to day 7 part 1:", IntCodeAssembly.findMaxOutput())
	}

	func testDay7Part2() {
		print("Solution to day 7 part 2:", FeedbackLoopAssembly.findMaxOutput())
	}
}
